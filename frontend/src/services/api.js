...
// calls so that you can keep all the networking operations or stuff related 
// to the API in a seperate file and find it easily when you need to make changes

const API_KEY = import.meta.env.VITE_API_KEY;  // free api key so no need to secure it
